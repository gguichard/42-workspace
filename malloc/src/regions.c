...
/*   Updated: 2019/07/25 23:00:37 by gguichar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_region	*init_malloc_region(void)
{
	...
	region = (t_region *)mmap(NULL
		, align_up(region_meta_size + region_data_size, getpagesize())
	...
	region->bitmap[0].order = 23; // log2(SMALL_QUANTUM * SMALL_MAX_BLOCKS)
	return (region);
}
